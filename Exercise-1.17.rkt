...
; Exercise 1.17: The exponentiation algorithms in this sec- tion are based on performing
...
; addition, opera- tions double, which doubles an integer, and halve, which divides an (even)
; integer by 2. Using these, design a mul- tiplication procedure analogous to fast-expt that uses a
